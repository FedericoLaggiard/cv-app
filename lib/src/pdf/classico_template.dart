...
class ClassicoTemplate {
  ...
  /// (mai header orfano a fine pagina), poi gli item restanti come blocchi
  /// separati (ognuno può cadere su una nuova pagina).
  static List<pw.Widget> _itemsSection<T>({
    ...
    if (items.isEmpty) return [_sectionHeader(header, sectionHeaderStyle)];
    final widgets = <pw.Widget>[
      pw.Inseparable(
        child: pw.Column(
          crossAxisAlignment: pw.CrossAxisAlignment.start,
          children: [
            _sectionHeader(header, sectionHeaderStyle),
            rowBuilder(items.first),
          ],
        ),
      ),
    ];
  ...
  static pw.Widget _esperienzaItem(
    ...
    final meta = [
      ...
      if (it.modalita != null) _modalitaLabel(it.modalita!, locale),
      if (it.tipoContratto != null)
        _tipoContrattoLabel(it.tipoContratto!, locale),
    ].join(' · ');
    return pw.Padding(
  ...
  static String _modalitaLabel(ModalitaLavoro m, LabelLocale locale) {
    const it = {
  ...
  static String _tipoContrattoLabel(TipoContratto t, LabelLocale locale) {
    const it = {
  ...
  static String _cefrLabel(LivelloCefr l, LabelLocale locale) {
